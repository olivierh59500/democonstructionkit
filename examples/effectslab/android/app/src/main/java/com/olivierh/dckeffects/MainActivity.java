package com.olivierh.dckeffects;
...
import com.olivierh.dckeffects.mobile.EbitenView;

import com.olivierh.dckeffects.mobile.Mobile;
import java.io.File;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (frames > 0) {
            if (profileName == null || profileName.isEmpty()) {
                profileName = eco ? "effectslab-eco.json" : "effectslab-high.json";
            }
            // Keep the report inside the application-private files directory.
