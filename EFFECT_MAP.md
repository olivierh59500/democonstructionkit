...
| Delta Force | YM register snapshots, `modulation.Change` and `Decay` for the three voice-triggered ball frames, scrolling, WaveStrips, `motion.BounceToggle` for the alternating logo and `motion.WrapBank` for the gold fill | The one-time word entrance/hold/exit and source-atop gold material remain screen composition. |
