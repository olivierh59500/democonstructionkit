...
| Multiscreen, camera tour | `motion.CameraTour` owns ten held/eased poses, exact handoff ticks, zoom and visible-scene masks; fixed views draw their demo directly | Move the four retained transition canvases and shader/fallback composition into a reusable renderer. |
