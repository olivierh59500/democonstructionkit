...
| Phenomena DNA intro | Atlas, DNAFrames, `scrolling.SliceProgram` with two-pixel insertion, loop-start and configurable control cues, plus `motion.RecurrentRowWave` for the staggered cosine baseline | Intro/outro reveal and bounce cues remain screen composition. |
