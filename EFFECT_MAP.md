...
| Coco, main | `Config.Scanline`, SolidCubeBatch, sprites.Group grid/translation, shared font metrics, `CopperBars`, `RotozoomBackground` source quad and `SurfaceLayer` with a moving title pass | The independent cube train can use shared path and timing primitives. |
