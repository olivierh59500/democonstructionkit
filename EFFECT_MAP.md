...
| Vectorballs | Projected shape factories, reflection and `geometry.PointMorph` with inherited coordinates and editable completion | Extract the remaining sinusoidal/rotor/positional deformations and complete action sequence with explicit inherited vs cleared settings. |
